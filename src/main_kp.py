...
arena_radius_px_dewarped = 3467.80
...
if __name__ == "__main__":
    ...
    # plot_phase(ds, 'density_voronoi_None', 'nematic_order_voronoi_None', plots_path, [r'Local density $(/m^2)$', 'Nematic order'], 'Locality: First shell', gridsize = 30, x_factor = 1)
    ...
    # plot_distribution_over_time(ds, 'density_voronoi_None', r'Local density $(/m^2)$', plots_path, '', y_factor = 1, start_frame = 0, end_frame = 3000, y_quant = 0.95, subsample = 5)
    # plot_distribution_over_time(ds, 'nematic_order_voronoi_None', 'Nematic order', plots_path, '', y_factor = 1, start_frame = 0, end_frame = 3000, subsample = 5)
    ...
    # interactive_voronoi_overlay(ds, 'theta', plots_path, arena_center_m, arena_radius_m, start_frame = 0, end_frame = 100, subsample = 1, cmap = 'hsv')
    # interactive_voronoi_overlay(ds, 'theta', plots_path, arena_center_m, arena_radius_m, start_frame = 0, end_frame = 1000, subsample = 20, cmap = 'hsv')

    # interactive_voronoi_overlay(ds, 'polarization_voronoi_None', plots_path, arena_center_m, arena_radius_m, start_frame = 0, end_frame = 100, subsample = 1, cmap = 'viridis')
    # interactive_voronoi_overlay(ds, 'polarization_voronoi_None', plots_path, arena_center_m, arena_radius_m, start_frame = 0, end_frame = 1000, subsample = 20, cmap = 'viridis')

    # interactive_voronoi_overlay(ds, 'nematic_order_voronoi_None', plots_path, arena_center_m, arena_radius_m, start_frame = 0, end_frame = 100, subsample = 1, cmap = 'viridis')
    # interactive_voronoi_overlay(ds, 'nematic_order_voronoi_None', plots_path, arena_center_m, arena_radius_m, start_frame = 0, end_frame = 1000, subsample = 20, cmap = 'viridis')
